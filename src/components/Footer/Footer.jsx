    ...
    <footer className="">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24 ">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className=" cursor-pointer flex justify-center items-center gap-3 text-teal-700 sm:justify-start">
              <svg
                className="h-8"
                viewBox="0 0 28 24"
                fill="none"
              ...
              <h1 className="text-6xl">Crest</h1>
            </div>

            <p className="mt-6 max-w-md text-center leading-relaxed text-white-500 sm:max-w-xs sm:text-left">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2 ">
            ...
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-white-900">Learn</p>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1 text-white-700">
                      sales@getcrest.ai
                    </span>
                  </a>
                </li>

                <li className="flex cursor-pointer items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="size-5 shrink-0 text-white-900"
                    fill="none"
        ...
        <div className="mt-12 border-t border-white-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="mt-4  text-sm text-white-500 sm:order-first sm:mt-0">
              &copy; 2024 Crest{" "}
              <span className="ml-4 cursor-pointer">Terms of service</span>{" "}
              <span className="ml-4 cursor-pointer">Privacy Policy</span>
            </p>
          </div>
        </div>
      </div>
